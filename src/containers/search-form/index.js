...
export class SearchFormComponent extends React.PureComponent {
	...
	isSearchButtonValid() {
		return moment(this.props.departureDate).isValid() &&
		...
		return (
			<div className="search-form__container">
				...
				<Button
					...
					icon="geosearch"
					large={true}
					disabled={!this.isSearchButtonValid()}
				>
					Search
				</Button>
			</div>
...
export const SearchForm = (props) => mountStores(SearchFormComponent, props, [ STORE_NAMES.FLY, STORE_NAMES.SEARCH ]);
